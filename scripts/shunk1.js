//================================================================================
// WEBFLOW CORE ANIMATION ENGINE - shunk1.js
// Animation system core, easing functions, timing utilities, and triggers
    ...
    ["87"],
    {
        ...
        5495: function(t, n, r) {
            ...
            t.exports = function(t, n, r, f) {
                ...
                n = o(n, t);
                for (
                    var a = -1, s = n.length, p = s - 1, l = t; null != l && ++a < s;
        ...
        195: function(t, n, r) {
            ...
            t.exports = function(t) {
                for (
                    var n = t.name + "", r = e[n], i = o.call(e, n) ? r.length : 0; i--;
        ...
        1185: function(t, n) {
            ...
            function f(t, n, r) {
                ...
                null == u && o(e);
                for (
                    var s = !1, p = arguments.length, l = Array(p > 3 ? p - 3 : 0), v = 3; v < p; v++
                )
                    l[v - 3] = arguments[v];
            ...
            function w(t, n, r, e, o, i) {
                for (
                    var u = arguments.length, c = Array(u > 6 ? u - 6 : 0), a = 6; a < u; a++
                )
                    c[a - 6] = arguments[a];
                return c.length ?
            ...
            function A(t, n) {
                for (
                    var r = Array.isArray(n) ? n : [n], e = !1, o = 0; o < r.length; o++
                )
                    if (u.call(t, r[o])) {
                        e = !0;
                        break;
