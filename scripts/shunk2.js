  ...
  ["93"],
  {
    ...
    3946: function (e, t, n) {
      ...
      let a = n(7087),
        ...
        D = () => ({ type: E }),
        G = (e, t) => ({ type: g, payload: { target: e, listenerParams: t } }),
        k = (e = 1) => ({ type: h, payload: { step: e } }),
        x = (e, t) => ({ type: m, payload: { stateKey: e, newState: t } }),
        V = (e, t) => ({ type: y, payload: { now: e, parameters: t } }),
        j = (e, t) => ({ type: I, payload: { key: e, value: t } }),
        B = (e) => ({ type: b, payload: { ...e } }),
        U = (e, t) => ({ type: T, payload: { instanceId: e, time: t } }),
        X = (e) => ({ type: _, payload: { instanceId: e } }),
        W = (e, t, n, i) => ({
          type: v,
    ...
    1970: function (e, t, n) {
                        ...
                        n.split(" ")
                          ...
                          .forEach((n) => {
                            ...
                            e.addEventListener(n, r),
                              t.dispatch((0, g.eventListenerAdded)(e, [n, r]));
                          });
                      };
                    Array.isArray(i)
                      ? i.forEach(y)
        ...
        if (l && l.useFirstGroupAsInitialState) {
          ...
          a.forEach((i) => {
            ...
            o.forEach((r) => {
              ...
              eg({
                destination: R({ element: r, actionItem: i, elementApi: h }, o),
                immediate: !0,
                store: e,
                element: r,
                eventId: n,
      ...
      function ep({
        ...
        let { ixInstances: a, ixSession: u } = e.getState(),
          c = u.hasBoundaryNodes && n ? h.getClosestElement(n, v) : null;
        (0, d.default)(a, (n) => {
      ...
      function eE({
        ...
        a >= E.length && (0, o.default)(f, "config.loop") && (a = 0),
          0 === a && g && a++;
        let m =
            (0 === a || (1 === a && g)) && T(f.action?.actionTypeId)
              ? f.config.delay
              : void 0,
          y = (0, o.default)(E, [a, "actionItems"], []);
        if (!y.length || !j(p, s.mediaQueryKey)) return !1;
        let I = s.hasBoundaryNodes && n ? h.getClosestElement(n, v) : null,
          b = M(y),
          _ = !1;
        return (
          y.forEach((o, l) => {
            ...
            E &&
              w({
                ...
                let E = p ? H(d)?.(s, o) : null,
                  g = p ? z(d)(s, o) : null;
                _ = !0;
                let y = D({ element: s, actionItem: o }),
                  I = R({ element: s, actionItem: o, elementApi: h }, E);
                eg({
                  store: e,
                  element: s,
                  actionItem: o,
      ...
      function eg(e) {
        ...
        L({ store: n, select: ({ ixInstances: e }) => e[f], onChange: ey }),
          l || n.dispatch((0, g.instanceStarted)(f, m.tick));
      }
      function eh(e, t) {
        ...
        let { elementId: n, actionItem: i } = e,
          ...
          { ref: a, refType: o } = r[n] || {};
        o === O && B(a, i, h), t.dispatch((0, g.instanceRemoved)(e.id));
      }
      function em(e, t, n) {
      ...
      function ey(e, t) {
        let {
          ...
          { events: v } = T,
          { mediaQueries: S = T.mediaQueryKeys } = v && v[d] ? v[d] : {};
        if (j(S, _.mediaQueryKey) && (i || n || r)) {
          if (l || (c === A && r)) {
            t.dispatch((0, g.elementStateChanged)(a, u, l, o));
            let { ixElements: e } = t.getState(),
              { ref: n, refType: i, refState: r } = e[a] || {},
              s = r && r[u];
            (i === O || $(u)) && F(n, r, s, d, o, y, h, c, b);
          }
          if (r) {
            if (m) {
              let e = eE({
      ...
      let {
        ...
        ea = (e) => (t, n) => {
          let { type: i } = t.nativeEvent,
            r = -1 !== [k, x].indexOf(i) ? i === k : n.isActive,
            a = { ...n, isActive: r };
        ...
        ep = {
          ...
          [_]: es(),
          [v]: ed(),
          [M]: { types: "ecommerce-cart-open", handler: z(W, H) },
          [P]: { types: "ecommerce-cart-close", handler: z(W, H) },
          [f]: {
            types: "click",
            handler: z(
              W,
          ...
          [S]: {
            ...
            handler: (
              ...
              return (
                ...
                (o !== u.EventBasedOn.ELEMENT || T || T !== a.elementHovered) &&
                  ((I = d ? 1 - I : I),
                  e.dispatch((0, l.parameterChanged)(b, I))),
                {
                  elementHovered: T,
                  clientX: p,
                  clientY: E,
          ...
          [D]: {
            types: "readystatechange IX2_PAGE_UPDATE",
            handler: z(U, (e, t) => (t || H(e), { started: !0 })),
          },
        };
    },
    4609: function (e, t, n) {
    ...
    4124: function (e, t, n) {
      ...
      let {
        ...
        eu = (e) => e.trim(),
        ec = Object.freeze({ [en]: N, [ei]: F, [er]: P }),
        el = Object.freeze({
      ...
      function eb({
        ...
        if (
          (w
            ? ((a = S.limitAffectedElements), (o = C), (u = d(S)))
            : (o = u = d({ id: b, selector: _, selectorGuids: v })),
          t && A)
        ) {
          let e = n && (u || !0 === A) ? [n] : f(C);
          if (u) {
            if (A === k) return f(u).filter((t) => e.some((e) => m(t, e)));
            if (A === M) return f(u).filter((t) => e.some((e) => m(e, t)));
            if (A === G) return f(u).filter((t) => e.some((e) => y(e, t)));
          }
          return e;
        }
      ...
      function eA(e, t = {}, n = {}, i, r) {
        ...
        switch (i.actionTypeId) {
          ...
          case ea:
            return { value: (0, a.default)(o(e, x), n.display) };
          case eo:
        ...
        switch (c) {
          case W:
            ...
            let m = ek
                ...
                .join(" "),
              { setStyle: S } = h;
            ej(s, E.TRANSFORM_PREFIXED, h),
              S(s, E.TRANSFORM_PREFIXED, m),
              (function (
                { actionTypeId: e },
          ...
          case Y:
            ...
            if (F.actionTypeId === ea) {
              ...
              M(N, x, e === A && E.IS_BROWSER_ENV ? E.FLEX_PREFIXED : e);
            }
            return;
          case H: {
      ...
      function ej(e, t, n) {
        ...
        let { getStyle: r, setStyle: a } = n,
          o = r(e, V);
        if (!o) return void a(e, V, i);
        let u = o.split(B).map(eu);
        -1 === u.indexOf(i) && a(e, V, u.concat(i).join(B));
      }
      function eB(e, t, n) {
        if (!E.IS_BROWSER_ENV) return;
        let i = el[t];
      ...
      function eW({ actionGroup: e, event: t, elementApi: n }) {
        ...
        i.forEach((e) => {
          ...
          (i = (0, p.isPluginType)(r)
            ...
            : e$({ effect: eH, actionTypeId: r, elementApi: n })),
            eb({ config: a, event: t, elementApi: n }).forEach(i);
        });
      }
      function eY(e, t, n) {
        ...
        r(e, V) && e$({ effect: eB, actionTypeId: a, elementApi: n })(e);
      }
      let e$ =
    ...
    5861: function (e, t, n) {
          ...
          switch (t.type) {
            ...
            case I: {
              let {
                ...
                l = e;
              return (
                (0, a.getIn)(l, [n, i]) !== i && (l = v(l, i, u, n, o)),
                O(l, n, c, r, o)
              );
            }
            case b: {
      ...
      function v(e, t, n, i, r) {
        ...
        return (0, a.mergeIn)(e, [i], { id: i, ref: t, refId: o, refType: n });
      }
        ...
        events: {
          e: {
            ...
            target: {
              selector: ".nav-logo",
              originalId:
                "6892c589ccd55f032c2d1b70|685f66ed-3bba-6c15-c6ea-0daca68bf575",
              appliesTo: "CLASS",
            },
            targets: [
              {
          ...
          "e-9": {
            ...
            target: {
              selector: ".block",
              originalId:
                "6892c589ccd55f032c2d1b70|11c2e056-94e5-73b2-1fe7-caeb32d94fef",
              appliesTo: "CLASS",
            },
            targets: [
              {
          ...
          "e-11": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "6892c589ccd55f032c2d1b70|b1251f73-8ba6-628d-3419-f15a5f3d64eb",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-15": {
            ...
            target: {
              selector: ".contact",
              originalId:
                "6892c589ccd55f032c2d1b70|5ef53bc3-40fd-9009-2854-5f2bb9982100",
              appliesTo: "CLASS",
            },
            targets: [
              {
          ...
          "e-19": {
            ...
            target: {
              ...
              originalId:
                "6892c589ccd55f032c2d1b70|5604fb18-0253-a07c-58df-032fe62b2e02",
              appliesTo: "CLASS",
            },
            targets: [
              {
          ...
          "e-21": {
            ...
            target: {
              ...
              originalId:
                "6892c589ccd55f032c2d1b70|73a509ab-1997-0ca9-4249-f0fb80d6c883",
              appliesTo: "CLASS",
            },
            targets: [
              {
          ...
          "e-23": {
            ...
            target: {
              ...
              originalId:
                "6892c589ccd55f032c2d1b70|08df633a-ec32-293c-ee83-032dc3258c3c",
              appliesTo: "CLASS",
            },
            targets: [
              {
          ...
          "e-27": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "6892c589ccd55f032c2d1b74|a0b7de75-8167-8e9e-209c-e038b83606d7",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-31": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "6892c589ccd55f032c2d1b73|a0b7de75-8167-8e9e-209c-e038b83606d7",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
                ...
                actionItems: [
                  {
                    ...
                    config: {
                      ...
                      duration: 500,
                      target: {
                        id: "6892c589ccd55f032c2d1b70|a8acba98-9f41-4af4-c935-b50efdd367df",
                      },
                      value: 1,
                      unit: "",
                    },
                ...
                actionItems: [
                  {
                    ...
                    config: {
                      ...
                      duration: 500,
                      target: {
                        id: "6892c589ccd55f032c2d1b72|ccb99eb8-d03e-76b2-aec9-78e4c2e154ab",
                      },
                      xValue: 0.85,
                      yValue: 0.85,
                      locked: !0,
